...
//     needle2.setRadius(0.40);
	...
	public void setupFixedPortrayals() {
		...
		roadPortrayal.setPortrayalForAll(new GeomPortrayal(new Color(65, 119, 193), 1, false));
		...
		countryPortrayal.setPortrayalForAll(new GeomPortrayal(new Color(249,239,219), 1, true));
